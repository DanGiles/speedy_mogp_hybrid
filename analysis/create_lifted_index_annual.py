...
for location in locations:
    ...
    if SPEEDY:
        ...
        np.save(
            os.path.join(analysis_root, "annual", f'{location}_SPEEDY_lifted_index_annual.npy'),
            output_array
        )
    ...
    if HYBRID:
        ...
        np.save(
            os.path.join(analysis_root, 'annual', f'{location}_HYBRID_lifted_index_annual.npy'),
            output_array
        )
