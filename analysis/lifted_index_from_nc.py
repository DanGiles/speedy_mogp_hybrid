...
for run in runs:
    print(run)
    # Read in the NetCDFs
    T = xr.load_dataset(os.path.join(output_dir, f'{run}_T.nc'))
    Q = xr.load_dataset(os.path.join(output_dir, f'{run}_Q.nc'))
    ps = xr.load_dataset(os.path.join(output_dir, f'{run}_ps.nc'))
